...
class GoodsReceiptController extends Controller
{
    ...
    public function getListPO(Request $request) {
        ...
        $subQ2= DB::table('t_po3 as a')
        ->leftJoin('t_gr3 as b','a.dtl3_key','=','b.base_ref')
        ->selectRaw('DISTINCT a.doc_key, b.doc_key AS gr_doc_key');
    ...
    public function getAllRef(Request $request) {
        ...
        ->leftJoin('t_po2 as b','a.base_ref','b.dtl2_key')
        ->selectRaw("a.dtl2_key, a.doc_key, a.no_urut, a.kd_bahan, a.satuan, a.qty, a.rp_harga,
            ...
            b.qty_sisa+a.qty AS qty_sisa_po")
        ->where("a.doc_key",$doc_key)
        ->orderBy("a.no_urut")
        ->get();
    ...
    public function store(Request $request) {
        ...
        try {
            ...
            foreach($dataTrans2 as $recTrans2) {
                ...
                $gr2->no_urut        = $recTrans2['no_urut'];
                $gr2->kd_bahan       = $recTrans2['kd_bahan'];
                $gr2->satuan         = $recTrans2['satuan'];
                $gr2->qty            = $recTrans2['qty'];
                $gr2->rp_harga       = $recTrans2['rp_harga'];
                $gr2->persen_diskon  = $recTrans2['persen_diskon'];
                $gr2->rp_diskon      = $recTrans2['rp_diskon'];
                $gr2->persen_diskon2 = $recTrans2['persen_diskon2'];
                $gr2->rp_diskon2     = $recTrans2['rp_diskon2'];
                $gr2->persen_diskon3 = $recTrans2['persen_diskon3'];
                $gr2->rp_diskon3     = $recTrans2['rp_diskon3'];
                $gr2->persen_diskon4 = $recTrans2['persen_diskon4'];
                $gr2->rp_diskon4     = $recTrans2['rp_diskon4'];
                $gr2->kd_pajak       = $recTrans2['kd_pajak'];
                $gr2->persen_pajak   = $recTrans2['persen_pajak'];
                $gr2->rp_pajak       = $recTrans2['rp_pajak'];
                $gr2->rp_harga_akhir = $recTrans2['rp_harga_akhir'];
                $gr2->qty_sisa       = $recTrans2['qty_sisa'];
                $gr2->catatan        = $recTrans2['catatan'];
                $gr2->fl_tutup       = $recTrans2['fl_tutup'];
            ...
            foreach($dataTrans3 as $recTrans3) {
                ...
                $gr3->no_urut        = $recTrans3['no_urut'];
                $gr3->no_account     = $recTrans3['no_account'];
                $gr3->nm_account     = $recTrans3['nm_account'];
                $gr3->catatan        = $recTrans3['catatan'];
                $gr3->rp_bayar       = $recTrans3['rp_bayar'];
                $gr3->rp_sisa        = $recTrans3['rp_sisa'];
                $gr3->base_type      = $recTrans3['base_type'];
                $gr3->base_ref       = $recTrans3['base_ref'];
                $gr3->save();
            }
